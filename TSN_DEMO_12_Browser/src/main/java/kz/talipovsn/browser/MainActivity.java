...
public class MainActivity extends AppCompatActivity {
    ...
    FloatingActionButton subsButton, historyButton, likedButton, laterButton, logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                hideSoftInput();
                // Загружаем страниу в webView
                webView.loadUrl(getString(R.string.history));
                // Показываем адрес домашней страницы
                urlText.setText(getString(R.string.history));
            }
        });
        ...
        subsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                hideSoftInput();
                // Загружаем страниу в webView
                webView.loadUrl(getString(R.string.liked));
                // Показываем адрес домашней страницы
                urlText.setText(getString(R.string.liked));
            }
        });
        ...
        laterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                hideSoftInput();
                // Загружаем страниу в webView
                webView.loadUrl(getString(R.string.later));
                // Показываем адрес домашней страницы
                urlText.setText(getString(R.string.later));
            }
        });
